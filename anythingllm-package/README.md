...
|---|---|---|
| Agent Skills (JS plugins) | 69 | One JS wrapper per Python `_tool.py` (across 81 skills) |
...
The master orchestrator has access to **all 81 USAP skills** and routes requests to the appropriate specialized agent.
