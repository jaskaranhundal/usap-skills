...
|---|---|---|
| Agent Skills (JS plugins) | 69 | One JS wrapper per Python `_tool.py` (across 80 skills) |
| Workspace | 1 | `cs-usap-orchestrator` — master router over all 13 cs-* agents |
...
The master orchestrator has access to **all 80 USAP skills** and routes requests to the appropriate specialized agent.
