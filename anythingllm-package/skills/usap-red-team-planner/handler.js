...
// USAP: Red Team Planner
// Domain: red-team
// Tool: red-team/red-team-planner/scripts/red-team-planner_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'red-team/red-team-planner/scripts/red-team-planner_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'red-team-planner', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'red-team-planner',
