...
// USAP: Ai Agent Security
// Domain: platform-ai
// Tool: platform-ai/ai-agent-security/scripts/ai-agent-security_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/ai-agent-security/scripts/ai-agent-security_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'ai-agent-security', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'ai-agent-security',
