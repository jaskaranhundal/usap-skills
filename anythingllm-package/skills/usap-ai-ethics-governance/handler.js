...
// USAP: Ai Ethics Governance
// Domain: platform-ai
// Tool: platform-ai/ai-ethics-governance/scripts/ai-ethics-governance_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/ai-ethics-governance/scripts/ai-ethics-governance_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'ai-ethics-governance', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'ai-ethics-governance',
