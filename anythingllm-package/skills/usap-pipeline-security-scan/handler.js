...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/pipeline-security-scan/scripts/pipeline-security-scan_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'pipeline-security-scan', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'pipeline-security-scan',
