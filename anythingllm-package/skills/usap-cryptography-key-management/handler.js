...
// USAP: Cryptography Key Management
// Domain: identity-access
// Tool: identity-access/cryptography-key-management/scripts/cryptography-key-management_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'identity-access/cryptography-key-management/scripts/cryptography-key-management_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'cryptography-key-management', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'cryptography-key-management',
