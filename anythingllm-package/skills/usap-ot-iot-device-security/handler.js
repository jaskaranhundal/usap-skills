...
// USAP: Ot Iot Device Security
// Domain: cloud-infra
// Tool: cloud-infra/ot-iot-device-security/scripts/ot-iot-device-security_tool.py
    ...
    try {
      ...
      if (!repoPath) {
        return JSON.stringify({
          ...
          skill: 'ot-iot-device-security'
        });
      }

      const toolPath = path.join(repoPath, 'cloud-infra/ot-iot-device-security/scripts/ot-iot-device-security_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'ot-iot-device-security', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'ot-iot-device-security',
