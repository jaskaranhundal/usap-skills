...
// USAP: Quantum Security Readiness
// Domain: risk-compliance
// Tool: risk-compliance/quantum-security-readiness/scripts/quantum-security-readiness_tool.py
    ...
    try {
      ...
      if (!repoPath) {
        return JSON.stringify({
          ...
          skill: 'quantum-security-readiness'
        });
      }

      const toolPath = path.join(repoPath, 'risk-compliance/quantum-security-readiness/scripts/quantum-security-readiness_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'quantum-security-readiness', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'quantum-security-readiness',
