...
// USAP: Security Awareness
// Domain: governance
// Tool: governance/security-awareness/scripts/security-awareness_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/security-awareness/scripts/security-awareness_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-awareness', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-awareness',
