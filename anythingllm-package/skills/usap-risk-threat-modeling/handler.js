...
// USAP: Risk Threat Modeling
// Domain: risk-compliance
// Tool: risk-compliance/risk-threat-modeling/scripts/risk-threat-modeling_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'risk-compliance/risk-threat-modeling/scripts/risk-threat-modeling_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'risk-threat-modeling', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'risk-threat-modeling',
