...
// Tool: appsec-devsecops/secure-sdlc/scripts/secure-sdlc_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/secure-sdlc/scripts/secure-sdlc_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'secure-sdlc', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'secure-sdlc',
