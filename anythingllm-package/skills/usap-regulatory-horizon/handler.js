...
// USAP: Regulatory Horizon
// Domain: risk-compliance
// Tool: risk-compliance/regulatory-horizon/scripts/regulatory-horizon_tool.py
    ...
    try {
      ...
      if (!repoPath) {
        return JSON.stringify({
          ...
          skill: 'regulatory-horizon'
        });
      }

      const toolPath = path.join(repoPath, 'risk-compliance/regulatory-horizon/scripts/regulatory-horizon_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'regulatory-horizon', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'regulatory-horizon',
