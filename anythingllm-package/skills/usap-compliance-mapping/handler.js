...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'risk-compliance/compliance-mapping/scripts/compliance-mapping_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'compliance-mapping', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'compliance-mapping',
