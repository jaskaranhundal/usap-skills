...
// USAP: Security Debt Tracker
// Domain: governance
// Tool: governance/security-debt-tracker/scripts/security-debt-tracker_tool.py
    ...
    try {
      ...
      if (!repoPath) {
        return JSON.stringify({
          ...
          skill: 'security-debt-tracker'
        });
      }

      const toolPath = path.join(repoPath, 'governance/security-debt-tracker/scripts/security-debt-tracker_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-debt-tracker', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-debt-tracker',
