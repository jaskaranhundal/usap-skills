...
// USAP: Agent Integrity Monitor
// Domain: platform-ai
// Tool: platform-ai/agent-integrity-monitor/scripts/agent-integrity-monitor_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/agent-integrity-monitor/scripts/agent-integrity-monitor_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'agent-integrity-monitor', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'agent-integrity-monitor',
