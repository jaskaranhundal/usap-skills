...
// USAP: Sre Runbook Advisor
// Domain: platform
// Tool: platform/sre-runbook-advisor/scripts/sre-runbook-advisor_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform/sre-runbook-advisor/scripts/sre-runbook-advisor_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'sre-runbook-advisor', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'sre-runbook-advisor',
