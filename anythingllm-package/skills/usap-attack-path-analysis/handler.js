...
// USAP: Attack Path Analysis
// Domain: red-team
// Tool: red-team/attack-path-analysis/scripts/attack-path-analysis_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'red-team/attack-path-analysis/scripts/attack-path-analysis_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'attack-path-analysis', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'attack-path-analysis',
