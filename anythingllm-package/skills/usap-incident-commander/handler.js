...
// USAP: Incident Commander
// Domain: response
// Tool: response/incident-commander/scripts/incident-commander_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'response/incident-commander/scripts/incident-commander_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'incident-commander', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'incident-commander',
