...
// USAP: Orchestrator
// Domain: platform-ai
// Tool: platform-ai/orchestrator/scripts/orchestrator_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/orchestrator/scripts/orchestrator_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'orchestrator', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'orchestrator',
