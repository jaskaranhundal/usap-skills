...
// USAP: Metrics Reporting
// Domain: governance
// Tool: governance/metrics-reporting/scripts/metrics-reporting_tool.py
    ...
    try {
      ...
      if (!repoPath) {
        return JSON.stringify({
          ...
          skill: 'metrics-reporting'
        });
      }

      const toolPath = path.join(repoPath, 'governance/metrics-reporting/scripts/metrics-reporting_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'metrics-reporting', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'metrics-reporting',
