...
// Tool: risk-compliance/privacy-dpia/scripts/privacy-dpia_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'risk-compliance/privacy-dpia/scripts/privacy-dpia_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'privacy-dpia', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'privacy-dpia',
