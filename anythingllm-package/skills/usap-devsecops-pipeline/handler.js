...
// USAP: Devsecops Pipeline
// Domain: appsec-devsecops
// Tool: appsec-devsecops/devsecops-pipeline/scripts/devsecops-pipeline_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/devsecops-pipeline/scripts/devsecops-pipeline_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'devsecops-pipeline', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'devsecops-pipeline',
