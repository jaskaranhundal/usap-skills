...
// USAP: Enterprise Risk Assessment
// Domain: risk-compliance
// Tool: risk-compliance/enterprise-risk-assessment/scripts/enterprise-risk-assessment_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'risk-compliance/enterprise-risk-assessment/scripts/enterprise-risk-assessment_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'enterprise-risk-assessment', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'enterprise-risk-assessment',
