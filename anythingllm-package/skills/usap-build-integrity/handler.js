...
// USAP: Build Integrity
// Domain: appsec-devsecops
// Tool: appsec-devsecops/build-integrity/scripts/build-integrity_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/build-integrity/scripts/build-integrity_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'build-integrity', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'build-integrity',
