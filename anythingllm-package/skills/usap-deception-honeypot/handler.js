...
// USAP: Deception Honeypot
// Domain: detection
// Tool: detection/deception-honeypot/scripts/deception-honeypot_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'detection/deception-honeypot/scripts/deception-honeypot_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'deception-honeypot', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'deception-honeypot',
