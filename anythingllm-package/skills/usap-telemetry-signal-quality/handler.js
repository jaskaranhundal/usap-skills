...
// USAP: Telemetry Signal Quality
// Domain: detection
// Tool: detection/telemetry-signal-quality/scripts/telemetry-signal-quality_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'detection/telemetry-signal-quality/scripts/telemetry-signal-quality_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'telemetry-signal-quality', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'telemetry-signal-quality',
