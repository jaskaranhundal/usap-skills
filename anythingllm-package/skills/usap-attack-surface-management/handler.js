...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'detection/attack-surface-management/scripts/attack-surface-management_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'attack-surface-management', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'attack-surface-management',
