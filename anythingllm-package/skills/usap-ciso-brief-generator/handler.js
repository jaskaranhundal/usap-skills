...
// USAP: Ciso Brief Generator
// Domain: governance
// Tool: governance/ciso-brief-generator/scripts/ciso-brief-generator_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/ciso-brief-generator/scripts/ciso-brief-generator_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'ciso-brief-generator', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'ciso-brief-generator',
