...
// USAP: Forensics
// Domain: response
// Tool: response/forensics/scripts/forensics_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'response/forensics/scripts/forensics_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'forensics', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'forensics',
