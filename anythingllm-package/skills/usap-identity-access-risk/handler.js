...
// USAP: Identity Access Risk
// Domain: identity-access
// Tool: identity-access/identity-access-risk/scripts/identity-access-risk_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'identity-access/identity-access-risk/scripts/identity-access-risk_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'identity-access-risk', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'identity-access-risk',
