...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/supply-chain-risk/scripts/supply-chain-risk_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'supply-chain-risk', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'supply-chain-risk',
