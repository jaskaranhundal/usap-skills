...
// USAP: Detection Engineering
// Domain: detection
// Tool: detection/detection-engineering/scripts/detection-engineering_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'detection/detection-engineering/scripts/detection-engineering_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'detection-engineering', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'detection-engineering',
