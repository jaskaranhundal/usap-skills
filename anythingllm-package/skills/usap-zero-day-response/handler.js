...
// USAP: Zero Day Response
// Domain: response
// Tool: response/zero-day-response/scripts/zero-day-response_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'response/zero-day-response/scripts/zero-day-response_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'zero-day-response', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'zero-day-response',
