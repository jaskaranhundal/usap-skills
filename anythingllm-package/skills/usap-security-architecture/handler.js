...
// USAP: Security Architecture
// Domain: governance
// Tool: governance/security-architecture/scripts/security-architecture_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/security-architecture/scripts/security-architecture_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-architecture', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-architecture',
