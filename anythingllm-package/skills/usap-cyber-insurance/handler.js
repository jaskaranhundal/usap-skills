...
// USAP: Cyber Insurance
// Domain: risk-compliance
// Tool: risk-compliance/cyber-insurance/scripts/cyber-insurance_tool.py
    ...
    try {
      ...
      if (!repoPath) {
        return JSON.stringify({
          ...
          skill: 'cyber-insurance'
        });
      }

      const toolPath = path.join(repoPath, 'risk-compliance/cyber-insurance/scripts/cyber-insurance_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'cyber-insurance', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'cyber-insurance',
