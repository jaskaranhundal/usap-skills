...
// USAP: Security Research
// Domain: red-team
// Tool: red-team/security-research/scripts/security-research_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'red-team/security-research/scripts/security-research_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-research', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-research',
