...
// USAP: Security Roadmap Planner
// Domain: governance
// Tool: governance/security-roadmap-planner/scripts/security-roadmap-planner_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/security-roadmap-planner/scripts/security-roadmap-planner_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-roadmap-planner', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-roadmap-planner',
