...
// USAP: Findings Tracker
// Domain: governance
// Tool: governance/findings-tracker/scripts/findings-tracker_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/findings-tracker/scripts/findings-tracker_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'findings-tracker', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'findings-tracker',
