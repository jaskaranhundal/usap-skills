...
// USAP: Zero Day Response Governance
// Domain: response
// Tool: response/zero-day-response-governance/scripts/zero-day-response-governance_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'response/zero-day-response-governance/scripts/zero-day-response-governance_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'zero-day-response-governance', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'zero-day-response-governance',
