...
// USAP: Tool Execution Broker
// Domain: platform-ai
// Tool: platform-ai/tool-execution-broker/scripts/tool-execution-broker_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/tool-execution-broker/scripts/tool-execution-broker_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'tool-execution-broker', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'tool-execution-broker',
