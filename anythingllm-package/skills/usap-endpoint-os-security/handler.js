...
// USAP: Endpoint Os Security
// Domain: cloud-infra
// Tool: cloud-infra/endpoint-os-security/scripts/endpoint-os-security_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'cloud-infra/endpoint-os-security/scripts/endpoint-os-security_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'endpoint-os-security', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'endpoint-os-security',
