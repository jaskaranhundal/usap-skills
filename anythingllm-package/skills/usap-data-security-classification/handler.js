...
// USAP: Data Security Classification
// Domain: identity-access
// Tool: identity-access/data-security-classification/scripts/data-security-classification_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'identity-access/data-security-classification/scripts/data-security-classification_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'data-security-classification', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'data-security-classification',
