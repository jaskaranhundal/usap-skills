...
// USAP: Guardrail
// Domain: platform-ai
// Tool: platform-ai/guardrail/scripts/guardrail_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/guardrail/scripts/guardrail_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'guardrail', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'guardrail',
