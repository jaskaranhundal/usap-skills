...
// USAP: Security Requirements Review
// Domain: appsec-devsecops
// Tool: appsec-devsecops/security-requirements-review/scripts/security-requirements-review_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/security-requirements-review/scripts/security-requirements-review_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-requirements-review', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-requirements-review',
