...
// USAP: Security Policy Control
// Domain: governance
// Tool: governance/security-policy-control/scripts/security-policy-control_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/security-policy-control/scripts/security-policy-control_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-policy-control', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-policy-control',
