...
// USAP: Knowledge Management
// Domain: governance
// Tool: governance/knowledge-management/scripts/knowledge-management_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/knowledge-management/scripts/knowledge-management_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'knowledge-management', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'knowledge-management',
