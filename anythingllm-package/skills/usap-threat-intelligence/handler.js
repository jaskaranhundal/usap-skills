...
// USAP: Threat Intelligence
// Domain: detection
// Tool: detection/threat-intelligence/scripts/threat-intelligence_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'detection/threat-intelligence/scripts/threat-intelligence_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'threat-intelligence', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'threat-intelligence',
