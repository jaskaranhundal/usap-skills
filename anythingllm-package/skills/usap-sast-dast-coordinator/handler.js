...
// USAP: Sast Dast Coordinator
// Domain: appsec-devsecops
// Tool: appsec-devsecops/sast-dast-coordinator/scripts/sast-dast-coordinator_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'appsec-devsecops/sast-dast-coordinator/scripts/sast-dast-coordinator_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'sast-dast-coordinator', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'sast-dast-coordinator',
