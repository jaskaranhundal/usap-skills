...
// USAP: Ai Red Teaming
// Domain: red-team
// Tool: red-team/ai-red-teaming/scripts/ai-red-teaming_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'red-team/ai-red-teaming/scripts/ai-red-teaming_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'ai-red-teaming', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'ai-red-teaming',
