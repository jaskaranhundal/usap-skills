...
// USAP: Cloud Workload Protection
// Domain: cloud-infra
// Tool: cloud-infra/cloud-workload-protection/scripts/cloud-workload-protection_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'cloud-infra/cloud-workload-protection/scripts/cloud-workload-protection_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'cloud-workload-protection', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'cloud-workload-protection',
