...
// USAP: Behavioral Analytics
// Domain: detection
// Tool: detection/behavioral-analytics/scripts/behavioral-analytics_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'detection/behavioral-analytics/scripts/behavioral-analytics_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'behavioral-analytics', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'behavioral-analytics',
