...
// USAP: Third Party Vendor Risk
// Domain: platform-ai
// Tool: platform-ai/third-party-vendor-risk/scripts/third-party-vendor-risk_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'platform-ai/third-party-vendor-risk/scripts/third-party-vendor-risk_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'third-party-vendor-risk', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'third-party-vendor-risk',
