...
// USAP: Security Posture Score
// Domain: governance
// Tool: governance/security-posture-score/scripts/security-posture-score_tool.py
...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'governance/security-posture-score/scripts/security-posture-score_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'security-posture-score', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'security-posture-score',
