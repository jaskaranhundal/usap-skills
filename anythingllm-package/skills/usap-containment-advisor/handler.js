...
module.exports.runtime = {
  handler: async function ({ input }) {
    try {
      ...
      const toolPath = path.join(repoPath, 'response/containment-advisor/scripts/containment-advisor_tool.py');
      ...
      return result || JSON.stringify({ status: 'completed', skill: 'containment-advisor', output: 'no output' });
    } catch (e) {
      return JSON.stringify({
        error: e.message,
        skill: 'containment-advisor',
