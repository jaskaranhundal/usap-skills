...
81 skill packages. 54 ship an executable analysis tool today; the other 27 `*_tool.py` scripts are declared stubs that exit non-zero with `status: not_implemented` and perform no analysis. The live census is in [`SELF-AUDIT.md`](SELF-AUDIT.md).
