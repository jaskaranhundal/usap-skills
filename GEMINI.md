...
80 standalone LLM skill packages + 13 cs-* orchestrator agents for the Unified
Security Agent Platform (USAP).

## Repo layout

- `<domain>/<slug>/SKILL.md` — LLM system prompt for each of the 80 skills
...
- `dist/USAP_BUNDLE.md` — all 80 skills embedded (684 KB)
