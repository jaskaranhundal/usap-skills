...
For the full project — 80 skills across 12 domains, 13 `cs-*` orchestrator agents, the typed 11-field output contract, framework mappings, validators, the design system, and the docs site — see the parent repo's [`README.md`](../../README.md).
