...
> **Version:** 2.0 | **Updated:** 2026-03-10 | **Scope:** All 66 skills · 6 agents · AnythingLLM integration
...
USAP is a collection of **66 standalone LLM skill packages** and **6 cs-* orchestrator agents** for running structured security operations workflows. Each `SKILL.md` is a complete, self-contained LLM system prompt. Skills are usable standalone (paste into any LLM) or deployed as USAP git submodule or AnythingLLM plugins.
...
```
usap-skills/
├── agents/                          # 6 cs-* orchestrator agents
